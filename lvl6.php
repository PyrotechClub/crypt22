...
if($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($answer == "shikarishambu" and $levels_no == 0) {
    ...
    } elseif ($answer == "trikurrdurr" and $levels_no == 1) {
    ...
    } elseif ($answer == "tricky" and $levels_no == 1) {
        $error = "<p class='text-danger'>https://crypt.teampyro.tech/lib/ticky.mp4</p>";
            ...
            <div class="row">
                ...
                <div class="col-md-8">
                    <div class="play-content">
                        <div class="play-box">
                            <h1 class="lvlno">Level <?php echo $levels_no + 1; ?></h1>
                            <?php if($levels_no == 0): ?>
                            <p class="lvltext">Shark Tank but not Shark Tank</p>
                            ...
                            <?php endif;?>
                            <?php if($levels_no == 1): ?>
                            <audio hidden autoplay id="bg-music">
                                <source src="lib/theupsidedown.mp3" type="audio/mpeg">
                            </audio>
                            <p class="lvltext">ʎʍʁɟNpƎN</p>
                            <audio controls id="lvl-music" onplay="pausebg()" onpause="playbg()">
                                <source src="lib/congrats.ogg" type="audio/ogg">
                            </audio>
                            <form method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>">
                                <input type="text" class="form-control" id="answer" name="answer"
                                    placeholder="Enter your answer here"><br>
